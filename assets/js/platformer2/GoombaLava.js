...
export class GoombaLava extends Character {
    ...
    collisionAction() {
        ...
        if (this.collisionData.touchPoints.other.id === "player") {
            ...
            if (this.collisionData.touchPoints.other.bottom && this.immune == 0) {
                ...
                this.canvas.style.transition = "transform 1s, opacity 1s";
                this.canvas.style.transform = "translate(0%, 100px) rotate(90deg)";
                this.canvas.style.opacity = "0";
                //this.canvas.style.transform = "translate(0%, 200px)";
                //this.canvas.style.transform = "rotate(90deg)";
                //this.canvas.style.transform = "translate(0%, 150px)";
                //this.canvas.style.transform = "translate(0%, 100px)";
